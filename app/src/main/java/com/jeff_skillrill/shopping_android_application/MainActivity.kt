...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in 1..25) {
            ...
            if (count == 0) {
                sneakers.add(Book(false, R.drawable.book_1, "The Four Agreements", 302.0, false))
            }
            if (count == 1) {
                sneakers.add(Book(false, R.drawable.book_1, "Night", 752.0, false))
            }
            if (count == 2) {
                sneakers.add(Book(false, R.drawable.book_1, "The Power of Now", 586.0, false))
            }
